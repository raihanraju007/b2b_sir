...
class Seller extends Frontend_Controller 
{
    ...
    public function brochure(){
        ...
        $this->load->view('seller/brochure');
    }
    ...
    public function brochure_save(){
        ...
        if($id > 0){
         ...
         redirect('seller/brochure', 'refresh');
    ...
    public function certificate(){
        ...
        $this->load->view('seller/certificate');
    }
    ...
    public function certificate_save(){
        ...
        if($id > 0){
         ...
         redirect('seller/certificate', 'refresh');
    ...
    public function account_settings(){
        ...
        $this->load->view('seller/account_settings');
    }
    ...
    public function get_verified(){
        ...
        $this->load->view('seller/get_verified');
    ...
    public function add_product(){
        ...
        $this->load->view('seller/product_add');   
    }
    ...
    public function product_save(){
        ...
        if(!empty($p_gallery)){
         ...
         redirect('seller/p_list', 'refresh');
    ...
    public function buysell(){
        ...
        $list = $this->sellermodel->get_buysell_list($company_id);
        
       // echo '<pre>';print_r($list);exit;
        
        $this->assign('list',$list);
        
         $this->load->view('seller/buysell');
    }
    
    public function view_buysell_info($id){
        
         $list = $this->sellermodel->get_buysell_info($id);
        
        $company_id = $this->session->userdata('company_id');
        $quatation = $this->sellermodel->get_quatation_list_for_buysell($company_id);
       // echo '<pre>';print_r($quatation);exit;
        $this->assign('list',$list);
		...
		$this->assign('type', $type);
         ...
         $this->load->view('seller/buysell_details');
