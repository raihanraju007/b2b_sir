															...
															<div class="d-flex px-4">
																<div>
																	...
																	<div class="mb-1 d-flex">
																		...
																		<span>
																			<a href="#"><?= htmlspecialchars($cat_info['category_name']); ?></a>
																		</span>
																	</div>
																	<!--<div class="mb-1 d-flex">-->
												...
												<div class="px-3 py-2 border-top">
													<div class="row align-items-center">
														...
														<div class="col-6 col-md-4 pl-md-4">
															<!--<a href="<?= site_url('company/product/' . $com_slag); ?>"><i class="fa fa-cube text-custom-link mr-1"></i>Products </a></div>-->
															
															<a href="<?= site_url('company/product/' . $company['slag']); ?>"><i class="fa fa-cube text-custom-link mr-1"></i>Products </a></div>
															
															<!--<a href="<?= site_url($company['slag']. '/product'); ?>"><i class="fa fa-cube text-custom-link mr-1"></i>Products </a></div>-->
