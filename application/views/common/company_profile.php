			...
			<div class="user-aside-menu py-3">
              ...
              <a href="https://b2bitem.com/myzone/communication" class="user-aside-menu-link">
                <span class="mr-2">
                  <i class="icofont-envelope"></i>
					...
					<li class="user-aside-menu-item">
						<a href="https://b2bitem.com/seller/p_list" class="user-aside-menu-link">
							<span class="mr-2">
								<i class="fa fa-cube"></i>
							</span> My Products </a>
					</li>
					<li class="user-aside-menu-item">
						<a href="https://b2bitem.com/seller/buysell" class="user-aside-menu-link">
							<span class="mr-2">
								<i class="fa fa-cube"></i>
							</span> Buy Sell</a>
					</li>
              ...
              <a href="https://b2bitem.com/myzone/buy-offer" class="user-aside-menu-link">
                <span class="mr-2">
                 ...
                 show                         ">
							<a href="<?= site_url('seller/brochure'); ?>" class="user-aside-submenu-item ">
								<span class="mr-2">
									<i class="fa fa-angle-right"></i>
								</span> Submit Brochure </a>
							<a href="<?= site_url('seller/certificate'); ?>" class="user-aside-submenu-item ">
								<span class="mr-2">
									<i class="fa fa-angle-right"></i>
								</span> Submit Certificate </a>
							<a href="<?= site_url('seller/video'); ?>" class="user-aside-submenu-item ">
								<span class="mr-2">
									<i class="fa fa-angle-right"></i>
              ...
              <a href="https://b2bitem.com/myzone/membership/info" class="user-aside-menu-link">
                <span class="mr-2">
                  <i class="fa fa-trophy"></i>
					...
					<li class="user-aside-menu-item  ">
						<a href="<?= site_url('seller/account_settings'); ?>" class="user-aside-menu-link">
							<span class="mr-2">
								<i class="fa fa-cog"></i>
							</span> Settings </a>
					</li>
